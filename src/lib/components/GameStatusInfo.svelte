...
>
	<div class="flex w-4/12 flex-col items-center justify-center">
		<h3 class="sm:text-xl md:text-3xl">Remaining Mines</h3>
		<h4 class="sm:text-xl md:text-2xl">
			{remainigMines}
		</h4>
	</div>
	<div class="flex w-4/12 flex-col items-center justify-center">
		<h3 class="sm:text-xl md:text-3xl">Remaining Cells</h3>
		<h4 class="sm:text-xl md:text-2xl">
			{remainingCells}
		</h4>
	</div>
	<div class="flex w-4/12 items-center justify-center">
		<div class="font-bold sm:text-2xl md:text-4xl">{formatSecondsToTime(secconds)}</div>
	</div>
</div>
